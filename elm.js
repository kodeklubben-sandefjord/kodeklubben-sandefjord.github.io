...
{
	if (region.af.L === region.ap.L)
	{
		return 'on line ' + region.af.L;
	}
	return 'on lines ' + region.af.L + ' through ' + region.ap.L;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { be: 'hidden', K: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { be: 'mozHidden', K: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { be: 'msHidden', K: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { be: 'webkitHidden', K: 'webkitvisibilitychange' }
		: { be: 'hidden', K: 'visibilitychange' };
}
...
var author$project$Main$initialModel = {x: 0};
...
var elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			bg: function (_n0) {
				return _Utils_Tuple2(impl.bg, elm$core$Platform$Cmd$none);
			},
			bp: function (_n1) {
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{bg: author$project$Main$initialModel, bs: author$project$Main$update, bu: author$project$Main$view});
